...
### Task 1: Define a new high score dictionary
...
### Task 2: Add players to high school dictionary
...
### Task 3: Remove players from the score dictionary
...
### Task 5: Update a player's score
...
### Task 6: Get a list of players with scores ordered by player name
...
### Task 7: Get a list of players ordered by player score in decreasing order
